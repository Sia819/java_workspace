...
public class NewsController extends HttpServlet 
{
				   ...
				   throws ServletException, IOException 
	{
		...
		try
		{
			...
			methodName = this.getClass().getMethod(action, HttpServletRequest.class);
			
			// 메서드 실행후 리턴값 받아옴
			view = (String)methodName.invoke(this, request);
		} 
    ...
    {
        int aid = Integer.parseInt(request.getParameter("aid"));
        System.out.println("GetNews => " + aid);
        try 
        {
